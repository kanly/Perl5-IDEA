...
$UID, ${UID};
$<, ${<error descr="PerlTokenType.ANNOTATION_PREFIX or PerlTokenType.LEFT_BRACE expected, got '<'"><</error>};
...
$^PREMATCH, ${^PREMATCH};
$POSTMATCH, ${POSTMATCH};
$', ${'<error descr="PerlTokenType.QUOTE_SINGLE_CLOSE or PerlTokenType.STRING_CONTENT expected, got '}'">}</error>;
$^POSTMATCH, ${^POSTMATCH};
